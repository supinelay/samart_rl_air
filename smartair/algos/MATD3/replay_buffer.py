...
class ReplayBuffer(object):
    def __init__(self, cfg, ob_dim, action_dim):
        ...
        self.buffer_obs, self.buffer_a, self.buffer_r, self.buffer_team_r, self.buffer_s_next, self.buffer_done = [], [], [], [], [], []
    ...
    def sample(self, index, device):
        ...
        batch_team_r = torch.tensor(self.buffer_team_r[index], dtype=torch.float).to(device)
        ...
        return batch_obs, batch_a, batch_r, batch_team_r, batch_obs_next, batch_done